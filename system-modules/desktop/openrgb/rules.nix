...
''
#---------------------------------------------------------------#
#  OpenRGB udev rules - Git Commit: e59f2841                    #
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="09da", ATTRS{idProduct}=="3666", TAG+="uaccess", TAG+="Bloody_W90_Max"
...
#---------------------------------------------------------------#
# Alienware AW410 Keyboard - DetectAlienwareAW410KControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="04f2", ATTRS{idProduct}=="1968", TAG+="uaccess", TAG+="Alienware_AW410K"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="3311", ATTRS{idProduct}=="a297", TAG+="uaccess", TAG+="Anne_Pro_2"
#---------------------------------------------------------------#
# Arctic RGB Controller Devices - DetectArcticControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="serial|hidraw", ATTRS{idVendor}=="1a86", ATTRS{idProduct}=="7523", TAG+="uaccess", TAG+="Arctic_RGB_controller"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1866", TAG+="uaccess", TAG+="ASUS_ROG_Strix_SCAR_17"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Asus Aura USB Mainboard - DetectAsusAuraUSBMotherboards
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1a70", TAG+="uaccess", TAG+="ASUS_ROG_Gladius_III_Wireless_Aimpoint_USB"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1a72", TAG+="uaccess", TAG+="ASUS_ROG_Gladius_III_Wireless_Aimpoint_24Ghz"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1979", TAG+="uaccess", TAG+="Asus_ROG_Spatha_X_Dock"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="19fc", TAG+="uaccess", TAG+="ASUS_ROG_Strix_Flare_II_Animate"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1aae", TAG+="uaccess", TAG+="ASUS_ROG_Strix_Scope_II_96_Wireless_USB"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Asus Aura Spatha - DetectAsusAuraUSBSpatha
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="181c", TAG+="uaccess", TAG+="ASUS_ROG_Spatha_Wired"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1824", TAG+="uaccess", TAG+="ASUS_ROG_Spatha_Wireless"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Asus Sagaris Keyboard - DetectAsusSagarisKeyboard
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1835", TAG+="uaccess", TAG+="ASUS_Sagaris_GK1100"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="2516", ATTRS{idProduct}=="0105", TAG+="uaccess", TAG+="Cooler_Master_MP750_Medium"
#---------------------------------------------------------------#
# Coolermaster Gaming Monitor - DetectCoolerMasterMonitor
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="2516", ATTRS{idProduct}=="01bb", TAG+="uaccess", TAG+="Cooler_Master_GM27FQS_ARGB_Monitor"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="0c12", TAG+="uaccess", TAG+="Corsair_Hydro_Series"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="0c13", TAG+="uaccess", TAG+="Corsair_Hydro_Series"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="0c15", TAG+="uaccess", TAG+="Corsair_Hydro_Series"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1bc7", TAG+="uaccess", TAG+="Corsair_K60_RGB_PRO_TKL"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1bc4", TAG+="uaccess", TAG+="Corsair_K70_RGB_PRO"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b73", TAG+="uaccess", TAG+="Corsair_K70_RGB_TKL"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1bb9", TAG+="uaccess", TAG+="Corsair_K70_RGB_TKL_Champion_Series"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b4b", TAG+="uaccess", TAG+="Corsair_Dark_Core_RGB_SE_Wired"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b7e", TAG+="uaccess", TAG+="Corsair_Dark_Core_RGB_Pro_SE_Wired"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b93", TAG+="uaccess", TAG+="Corsair_Katar_Pro"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1bba", TAG+="uaccess", TAG+="Corsair_Katar_Pro_V2"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1bac", TAG+="uaccess", TAG+="Corsair_Katar_Pro_XT"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1bb5", TAG+="uaccess", TAG+="Corsair_M65_Ultra_RGB_Wired"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1ba6", TAG+="uaccess", TAG+="Corsair_Slipstream_Wireless_Receiver"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# EVision V2 Keyboard - DetectEVisionV2Keyboard
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="320f", ATTRS{idProduct}=="5041", TAG+="uaccess", TAG+="CSBICL01_Keyboard"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Aorus Laptop - DetectGigabyteAorusLaptopControllers
#---------------------------------------------------------------#
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="03f0", ATTRS{idProduct}=="048c", TAG+="uaccess", TAG+="HyperX_Quadcast_S"
...
#---------------------------------------------------------------#
#---------------------------------------------------------------#
# LGMonitor - DetectLGMonitorControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="043e", ATTRS{idProduct}=="9a8a", TAG+="uaccess", TAG+="LG_27GN950B_Monitor"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Lenovo 4 Zone USB - DetectLenovo4ZoneUSBControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c963", TAG+="uaccess", TAG+="Lenovo_Ideapad_315ach6"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c985", TAG+="uaccess", TAG+="Lenovo_5_2023"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c984", TAG+="uaccess", TAG+="Lenovo_5_2023_Ideapad"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c975", TAG+="uaccess", TAG+="Lenovo_5_2022"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c973", TAG+="uaccess", TAG+="Lenovo_5_2022_Ideapad"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c965", TAG+="uaccess", TAG+="Lenovo_5_2021"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c963", TAG+="uaccess", TAG+="Lenovo_5_2021_Ideapad"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c955", TAG+="uaccess", TAG+="Lenovo_5_2020"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c978", TAG+="uaccess", TAG+="Lenovo_Legion_7_Gen_7"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="048d", ATTRS{idProduct}=="c988", TAG+="uaccess", TAG+="Lenovo_Legion_7_Gen_8"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Lian Li GAII Trinity - DetectLianLiGAIITrinity
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0416", ATTRS{idProduct}=="7373", TAG+="uaccess", TAG+="Lian_Li_GA_II_Trinity"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0416", ATTRS{idProduct}=="7371", TAG+="uaccess", TAG+="Lian_Li_GA_II_Trinity_Performance"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a102", TAG+="uaccess", TAG+="Lian_Li_Uni_Hub__SL_Infinity"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a101", TAG+="uaccess", TAG+="Lian_Li_Uni_Hub__AL"
#---------------------------------------------------------------#
# Lian Li Uni Hub SL Infinity - DetectLianLiUniHubSLInfinity
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a102", TAG+="uaccess", TAG+="Lian_Li_Uni_Hub__SL_Infinity"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="046d", ATTRS{idProduct}=="c09d", TAG+="uaccess", TAG+="Logitech_G203_Lightsync"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1462", ATTRS{idProduct}=="7d40", TAG+="uaccess", TAG+="MSI_Mystic_Light_MS7D40"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1462", ATTRS{idProduct}=="7d97", TAG+="uaccess", TAG+="MSI_Mystic_Light_MS7D97"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1462", ATTRS{idProduct}=="7e10", TAG+="uaccess", TAG+="MSI_Mystic_Light_MS7E10"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0db0", ATTRS{idProduct}=="0076", TAG+="uaccess", TAG+="MSI_Mystic_Light_Common"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e71", ATTRS{idProduct}=="2019", TAG+="uaccess", TAG+="NZXT_RGB__Fan_Controller"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="3061", ATTRS{idProduct}=="4716", TAG+="uaccess", TAG+="Nollie_16CH"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="16d2", ATTRS{idProduct}=="1616", TAG+="uaccess", TAG+="Nollie_28_12"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="16d2", ATTRS{idProduct}=="1617", TAG+="uaccess", TAG+="Nollie_28_L1"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="16d2", ATTRS{idProduct}=="1618", TAG+="uaccess", TAG+="Nollie_28_L2"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="028d", TAG+="uaccess", TAG+="Razer_Blackwidow_V4_Pro"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="0293", TAG+="uaccess", TAG+="Razer_Blackwidow_V4_X"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="0298", TAG+="uaccess", TAG+="Razer_Deathstalker_V2_Pro_TKL_Wired"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="0296", TAG+="uaccess", TAG+="Razer_Deathstalker_V2_Pro_TKL_Wireless"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="02a2", TAG+="uaccess", TAG+="Razer_Ornata_V3_X_Rev2"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="029d", TAG+="uaccess", TAG+="Razer_Blade_14_2023"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="00b9", TAG+="uaccess", TAG+="Razer_Basilisk_V3_X_HyperSpeed"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="0069", TAG+="uaccess", TAG+="Razer_Mamba_Hyperflux_Wired"
...
#---------------------------------------------------------------#
#---------------------------------------------------------------#
# Roccat Sense Aimo Mousepad - DetectRoccatSenseAimoControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e7d", ATTRS{idProduct}=="343a", TAG+="uaccess", TAG+="Roccat_Sense_Aimo_Mid"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e7d", ATTRS{idProduct}=="343b", TAG+="uaccess", TAG+="Roccat_Sense_Aimo_XXL"
#---------------------------------------------------------------#
# Roccat Vulcan Keyboard - DetectRoccatVulcanKeyboardControllers
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e7d", ATTRS{idProduct}=="3124", TAG+="uaccess", TAG+="Roccat_Magma"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="16d0", ATTRS{idProduct}=="1205", TAG+="uaccess", TAG+="SRGBMods_LED_Controller_v1"
#---------------------------------------------------------------#
# Genesis Xenon 200 - DetectSinowealthMouse
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1038", ATTRS{idProduct}=="151c", TAG+="uaccess", TAG+="SteelSeries_QCK_Prism_Cloth_XL_CSGO_Neo_Noir_Ed"
...
#---------------------------------------------------------------#
# Winbond Gaming Keyboard - DetectWinbondGamingKeyboard
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0416", ATTRS{idProduct}=="b23c", TAG+="uaccess", TAG+="Winbond_Gaming_Keyboard"
#---------------------------------------------------------------#
